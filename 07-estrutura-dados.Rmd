...
```{r fig-multiplicacao-mat, fig.cap="Multiplicação matricial.", echo = FALSE, out.width="100%"}
...
Veremos que no R, listas são frequentemente usadas para armazenar a saída de funções com diversos resultados. Como por exemplo a saída da função `rle()`.
```
