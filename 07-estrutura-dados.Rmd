...
`r paste("  ")`a. Na sequência de valores `r set.seed(2); paste0(paste( (nums <- sample(1:100, 10)) , collapse = ", "))` obtenha o vetor lógico indicando quais números são pares. Calcule o total de números ímpares.
