...
Para atualizar o R no Windows, ao invés de baixar o executável da nova versão,  você pode utilizar o pacote [**installr**](https://cran.r-project.org/web/packages/installr/index.html). A instalação de pacotes no `r rblue` será vista na seção \@ref(install-pck).
