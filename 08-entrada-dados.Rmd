...
```{r, eval = FALSE, fig.width=11, fig.height=4.8}
...
```
    ...
    b. Defina o nome das variáveis como: `r paste(c(var_nomes, "status"), collapse = ", ")`. Tente obter os nomes das variáveis do próprio link para os dados (Releia a seção \@ref(arquivos-fwf) e a seção \@ref(scan) para detalhes). Mostre os 10 primeiros valores da variável `RMM1`.
