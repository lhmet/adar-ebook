...
Você pode configurar o diretório de trabalho pelo menu do Rstudio *Session > Set Working Directory*. Você terá entre as opções: 
...
```{r Chunk445, eval=FALSE}
soi.df <- read.csv(file = "data/SOI.csv",
                   header = TRUE,
                   na.strings = "-999.9")
```

```{r chunk446, eval=FALSE}
head(soi.df)
str(soi.df)
```
