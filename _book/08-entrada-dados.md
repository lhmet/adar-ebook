...
(arq_temp <- tempfile())
#> [1] "/tmp/RtmpRDNIWZ/file5bdc7bad5fa8"
(hidroweb_dest_file <- paste0(arq_temp, ".csv"))
#> [1] "/tmp/RtmpRDNIWZ/file5bdc7bad5fa8.csv"
download.file(
...
(arq_temp <- tempfile())
#> [1] "/tmp/RtmpRDNIWZ/file5bdc22ac7f3f"
(dprec_file <- paste0(arq_temp, ".tsv"))
#> [1] "/tmp/RtmpRDNIWZ/file5bdc22ac7f3f.tsv"
...
```r
dest_file_nc
#> [1] "/tmp/RtmpRDNIWZ/cru10min30_tmp.nc"
...
print(ncin)
#> File /tmp/RtmpRDNIWZ/cru10min30_tmp.nc (NC_FORMAT_CLASSIC):
#> 
...
#> data source : /tmp/RtmpRDNIWZ/cru10min30_tmp.nc 
...
#>   writexl  9.115885 10.25804 161.6808  16.3708  16.94572 755.7138     5
#>  openxlsx 61.196449 71.35813 222.4962 124.7841 393.60253 461.5396     5
#>  cld
#>    a
#>    a
```
...
O resultado é que a `writexl::write_xlsx()` foi cerca de 1 vezes mais rápida na escrita dos dados que a `openxlsx::write.xlsx`.
