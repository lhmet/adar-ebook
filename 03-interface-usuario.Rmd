...
Este conjunto de linhas de código, quando inseridos em um arquivo texto[^9] formam um primeiro *script* `r rblue`. Este *script* pode ser executado pelo `r rblue` através da função `source()`, usando como argumento o caminho para o local do *script*. 
