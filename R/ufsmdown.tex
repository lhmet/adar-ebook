%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Base para o documento: MDT UFSM 2015 ver. 1.00 (24/02/2016) %%
%%%%%%%%%% Modelo de Trabalho de Disciplina versão 2019 %%%%%%%%%
%%%%%%%%%%%%%%% Baseado no padrão MDT UFSM 2015 %%%%%%%%%%%%%%%%%
%%%%%%%%%%%%% Atualizado em 17/10/2019 por Lucas Fank %%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\centroensino{Seu Centro de Ensino}  %%% NOME POR EXTENSO
\centroensinosigla{SIGLA}  %%% SIGLA

% % CURSO DA UFSM
\nivelensino{NÍVEL}  %%%%%%% NIVEL DE ENSINO - Bacharelado/Licenciatura/Tecnólogo...
\curso{Seu Curso}   %%%%% NOME POR EXTENSO
\ppg{SIGLA}   %%%%%% SIGLA
\statuscurso{Curso Superior}  %%%% STATUS= {Programa} ou {Curso}


% % % % % % % % % % INFORMACOES DO AUTOR % % % % % % % % % %
\author{Seu Nome}   %%%%% AUTOR DO TRABALHO
...
\email{seuemail@ufsm.br}   %%%% E-MAIL PARA CATALOGRAFICA (COPYRIGHT) - OBRIGATORIO
\endereco{Av. Roraima, 1000, Camobi} %%%% TELEFONE PARA CATALOGRAFICA (COPYRIGHT) (CAMPO OPICIONAL -- CASO NAO POSSUA OU NAO QUEIRA DIVULGAR COMENTE A LINHA)
...
\orientador{Professor}{MSc}{UFSM}{M}{P}  %%%INFORMACOES SOBRE ORIENTADOR: OS CAMPOS SAO:{NOME}{SIGLA DA TITULACAO}{SIGLA DA INSTITUICAO DE ORIGEM}{SEXO} M=masculino   F=feminino {PARTE DA BANCA?} P=presidente  M=Membro  N=Nao faz parte
...
% % % %  TITULO DO TRABALHO
\titulo{Título do trabalho} %% NAO EH NECESSARIO CAPITALIZAR
% % % %  TITULO DO TRABALHO EM INGLES
\englishtitle{Título em inglês}  %% NAO EH NECESSARIO CAPITALIZAR
...
%     \tipogenerico{Relatório resultado de pesquisa}
%     \tipogenericoen{Research report}
%     \concordagenerico{o}
%     \graugenerico{Tecnólogo em Redes de Computadores}
%\relatorioDisc   %%% Alternativa para aqueles cursos que nao recebem o titulo de bacharel ou licenciado. Ex: engenharia, arquitetura, etc... Os campos abaixo tambem devem ser preenchidos
%	\tiporelatorioDisc{Relatório resultado de pesquisa}
%	\graurelatorioDisc{Tecnólogo em Redes de Computadores}


% % % DATA DA DEFESA
\data{DD}{MM}{2019} %% FORMATO {DD}{MM}{AAAA}
...
\resumo{
Resumo aqui. Se não quiser usar só comentar da linha anterior até (inclusive) as palavras chave.
}
...
\end{verbatim}
  ...
  Sobre a circulação geral da atmosfera pode-se dizer que os ventos do norte não movem moinhos \apud{livro:monin:v1}{apud:richardson1922}.
\begin{center}\rule{0.5\textwidth}{1pt}\end{center}
...
\end{verbatim}
	  ...
	  \end{verbatim}
		...
		\caption{\label{exepretex} Sequência dos elementos pré-textuais da MDT-UFSM}
		\vspace{\baselineskip} %%% linha em branco para atender a norma
...
%         \begin{grafico}[ht]
%     	    \caption{\label{exepretex1} Sequência dos elementos pré-textuais da MDT-UFSM}
%	    \centering
%	    \includegraphics[width=0.6\textwidth]{figuras/pretextuais.png}
%	    \vspace{\baselineskip} %%% linha em branco para atender a norma
%            \fonte{Adaptado de \citeonline{man:MDTUFSM2012}.}
