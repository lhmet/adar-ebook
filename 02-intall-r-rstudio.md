...
<p class="caption">(\#fig:rstudio-choose)Opção para baixar o RStudio *Desktop*.</p>
  ...
  3. Clique na sua plataforma (de acordo com seu SO, arquitetura e versão da distribuição) (Figura \@ref(fig:rstudio-plat)), no exemplo deste livro *RStudio 1.2.5033 - Ubuntu 16.04.6 LTS (64-bit)*.
