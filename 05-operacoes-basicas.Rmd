...
```{r chunk17, render.args = list(help = list(sections = "Details")), eval = TRUE}
?atan2
```
...
```{r google-it, ref.label='google-it', echo = FALSE, fig.align='center', fig.cap="Aprenda como descobrir qual o significado das mensagens de erro.", out.width='50%'}
knitr::include_graphics('images/practicalDev_googleErrorMessage.jpg')
```
